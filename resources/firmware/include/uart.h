 ...
 * a power of 2. You may need to adapt these constants to your target and your
 * application by adding CDEFS += -DUART_RX_BUFFER_SIZE=nn
 * -DUART_TX_BUFFER_SIZE=nn to your Makefile.
 *
 ...
 * adding CDEFS += -DUART_RX_BUFFER_SIZE=nn to your Makefile.
 */
 ...
 *
 *  You may need to adapt this constant to your target and your application by
 * adding CDEFS += -DUART_TX_BUFFER_SIZE=nn to your Makefile.
 */
